...
public class CatchFlowMetricsModel {
	...
	public CatchFlowMetricsModel(String filePath, String project, int catchQuantity, int catchSizeLOC,
	...
	public static void GenerateCSVFromList(List<CatchFlowMetricsModel> catchFlowMetricsList, String csvName, String column) {
		try {
			FileWriter writer = new FileWriter(csvName);
			writer.write(column + "\n");
			
			for(CatchFlowMetricsModel model : catchFlowMetricsList) {
