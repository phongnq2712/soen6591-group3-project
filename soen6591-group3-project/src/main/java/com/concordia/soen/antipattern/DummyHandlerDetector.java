...
public class DummyHandlerDetector {
	static ASTParser parser = ASTParser.newParser(AST.getJLSLatest());
	public static int count = 0;
	
	public DummyHandlerDetector(String file) {
		detectDummyHandlerDetector(file);
	}
	
	public static void detectDummyHandlerDetector(String file) {
		count = 0;
		String source = "";
